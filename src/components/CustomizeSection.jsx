...
const CustomizeSection = ()=>{
    return(
        <>
        <div className="container py-10  m-auto bg-yellow-300 shadow-inner mt-20">
            ...
            <div className="glasscontainer bg-white shadow-md  bg-opacity-60 backdrop-blur gap-4 py-7 px-4 rounded-lg flex flex-col justify-evenly items-center m-auto w-10/12 md:flex-row">
                ...
                <div className="right flex flex-col gap-2 text-yellow-800">
                    ...
                    <h1 className='font-semibold text-lg'>Let's Customize your D-Burger</h1>
                    <button className='btn font-bold text-lg bg-yellow-300 hover:bg-yellow-400 text-yellow-900 w-1/2'>Customize </button>
                </div>
